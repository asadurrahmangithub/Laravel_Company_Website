...
@section('active-service')
    active open
@endsection
@section('sub-menu-service-active-3')
    active
@endsection
@section('content')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add New Service Card Section</h5>
                        <small class="text-muted float-end">Please Add</small>
                    </div>
                    <div class="card-body">
                        <form action="{{route('save-card-service')}}" method="post" >
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Icon Class</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" required name="service_icon_class" id="basic-default-name" placeholder="Enter Your Service Icon Class Name" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Service Card Title</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" required name="service_card_title" id="basic-default-name" placeholder="Enter Your Service Card Title Name" />
                                </div>
                            </div>
                            <div class="row mb-3">
