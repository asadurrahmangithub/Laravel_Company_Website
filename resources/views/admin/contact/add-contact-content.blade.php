...
@section('active-contact')
    active open
@endsection
@section('sub-menu-contact-active-3')
    active
@endsection
@section('content')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add New Contact Info</h5>
                        <small class="text-muted float-end">Please Add</small>
                    </div>
                    <div class="card-body">
                        <form action="{{route('save-contact-info')}}" method="post" >
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Icon Class</label>
                                <div class="col-sm-10">
                                    <input type="text" name="contact_icon_class" required class="form-control" id="basic-default-name" placeholder="Enter Your Contact Info Icon Class Name" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Contact Title</label>
                                <div class="col-sm-10">
                                    <input type="text" name="contact_info_title" required class="form-control" id="basic-default-name" placeholder="Enter Your Contact Title Name" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-message">Sub Contact Title</label>
                                <div class="col-sm-10">
                            <textarea
